      ...
      <div className="container">
        <div className="row">
          <div className="col-md-5">
            ...
            <div className="flex flex-wrap w-screen items-center justify-center text-center gap-x-36 gap-y-4">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((index) => (
                <div key={index} className="my-5 ml-2">
              ...
              <Transition show={isOpen} as={React.Fragment}>
                ...
                >
                  <div className="min-h-screen px-4 text-center">
                    ...
                    >
                      <div
                        className="inline-block my-8 w-full max-w-md overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl mt-60 mx-auto"
