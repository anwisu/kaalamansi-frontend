  ...
  return (
    ...
    <div>
      ...
      >
        ...
        <div class="p-10 py-10 bg-gray-200 text-center mx-auto rounded-2xl">
          <div>
            ...
            <div className="grid grid-cols-2 text-left gap-auto">
              <div className="col-span-1">
                <p className="text-gray-600 text-sm">
                  <b>Discoloration:</b>{" "}
                  {combinedDiseaseData.disease_data.discoloration}
                </p>
                <p className="text-gray-600 text-sm">
              ...
              <div className="col-span-1">
                ...
                <p className="text-gray-600 text-sm">
                  <b>Pesticide:</b>{" "}
                  {combinedDiseaseData.disease_data.pesticide_use}
                </p>
                <p className="text-gray-600 text-sm">
                  <b>Pest Presence:</b>{" "}
      ...
      <div class="mt-10 items-center mx-auto text-center justify-center ">
        <div class="mt-10 items-center mx-auto text-center justify-center">
          ...
          <div>
            {combinedDiseaseData ? (
              <div class="mx-20 my-10 flex flex-wrap justify-center">
                {combinedDiseaseData.fertilizerReco && (
                  <div class="p-10 py-10 bg-gray-100 text-center item-center justify-center rounded-2xl w-96 h-56 mx-4">
                    <>
