...
const Register = () => {
  ...
  return (
          ...
          >
            ...
            <div className="inputDiv">
              <div class="grid items-center gap-1.5">
                <label class="text-sm text-gray-900 font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  Avatar
                </label>
                <div className="registerFlex items-center">
                  <input
                    type="file"
                    name="avatar"
                    id="customFile"
                  ...
                  />
                  {avatarPreview && (
                    <Avatar src={avatarPreview} size="large" className="ml-1" />
                  )}
                </div>
              </div>
    ...
    //       </div>
    //     </div>
    //     <div className="flex-1 bg-indigo-100 text-center hidden lg:flex video-container">
    //       <video src='./videos/watering-plants.mp4' autoPlay muted loop className="video-background"></video>
    //     </div>
    //   </div>
    // </div>
  );
